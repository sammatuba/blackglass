...
const BEA: CaseOS = {
  ...
  photos: [
    {
      ...
      series: { id: 'healthtruthph', note: 'Same layout, same “EXPOSED,” same .click family — different vegetable. The sameness is the tell.' },
      evidence: 'ev-kk-shot',
    },
    {
      id: 'kk-ampalaya-shot',
      title: 'Screenshot · ampalaya link preview',
      kind: 'screenshot',
      emoji: '📱',
      src: artifactUrl('ampalaya-clickbait'),
      requires: 'bea_fast',
      series: { id: 'healthtruthph', note: 'Same layout, same “EXPOSED,” same .click family — different vegetable. The sameness is the tell.' },
      evidence: 'ev-ampalaya',
    },
    {
      id: 'kk-malunggay-shot',
      title: 'Screenshot · malunggay link preview',
      kind: 'screenshot',
      emoji: '📱',
      src: artifactUrl('malunggay-clickbait'),
      requires: 'bea_fast',
      series: { id: 'healthtruthph', note: 'Same layout, same “EXPOSED,” same .click family — different vegetable. The sameness is the tell.' },
      evidence: 'ev-malunggay',
    },
  ],
  ...
  evidenceLabels: {
    ...
    'ev-malunggay': 'Found the malunggay third of the batch',
