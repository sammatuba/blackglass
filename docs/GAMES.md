...
| **Scam Radar** | TRAIN | `src/games/scam-radar/` | Scam-readiness skills: judge the feed (Scam / Legit / Verify first), investigate case files, respond safely. Red-flag taxonomy: urgency, authority/impersonation, payment, too-good-to-be-true, emotional leverage, channel anomalies. | Platform (React + Vite + TS), shared phone/beat engine | `building` |
